...
from src.project_origin.models import BrandLanguage, NameCandidate
...
class NameEvaluator:
    ...
    def evaluate(
        ...
        for name in names:
            candidate = cls._evaluate_single_name(name, brand_language)
            evaluated_names.append(candidate)
